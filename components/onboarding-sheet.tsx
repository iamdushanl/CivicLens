...
function OnboardingSheet({ onDone }: OnboardingSheetProps) {
    ...
    if (showSteps) {
        ...
        return (
            <div className="fixed inset-0 z-[400] flex h-full w-full flex-col bg-[#1A73E8]" style={{ background: "#1A73E8" }}>
                {/* Skip */}
    ...
    return (
        <div className="fixed inset-0 z-[400] flex h-full w-full flex-col items-center justify-between bg-[#1A73E8]" style={{ background: "#1A73E8" }}>
